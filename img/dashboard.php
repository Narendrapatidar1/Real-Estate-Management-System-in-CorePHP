...
if (strlen($_SESSION['useruid']==0)) {
 ...
 $sql="update user set FirstName=:fname,LastName=:lname,MobileNumber=:mobno,Country=:country where ID=:uid";
...
{               ?>
                                                        ...
                                                        <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" maxlength="10" pattern="[0-9]+" name="mobno" value="<?php  echo $row->MobileNumber;?>" required="true" />
                                                                </div>
                                                            </div>
                                                        </div>
